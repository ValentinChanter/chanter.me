...
- a french Wikipedia race (or Wikirace) random bingo generator that features:
  - a 5x5 grid made with words retrieved from a local file, downloaded from the [20251007 Wikipedia dump of all titles in namespace 0](https://dumps.wikimedia.org/other/pagetitles/20250317/frwiki-20251007-all-titles-in-ns-0.gz).
